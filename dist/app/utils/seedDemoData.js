...
const destination_model_1 = require("../modules/Destination/destination.model");
const country_model_1 = require("../modules/Country/country.model");
const faq_model_1 = require("../modules/Faq/faq.model");
const testimonial_model_1 = require("../modules/Testimonial/testimonial.model");
const booking_model_1 = require("../modules/Booking/booking.model");
const seedDemoData = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const serviceCount = yield service_model_1.Service.countDocuments();
        if (serviceCount === 0) {
            yield service_model_1.Service.create([
                {
        ...
        const destCount = yield destination_model_1.Destination.countDocuments();
        if (destCount === 0) {
            yield destination_model_1.Destination.create([
                {
        ...
        const countryCount = yield country_model_1.Country.countDocuments();
        if (countryCount === 0) {
            yield country_model_1.Country.create([
                {
                    name: "United Kingdom",
        ...
        const faqCount = yield faq_model_1.Faq.countDocuments();
        if (faqCount === 0) {
            yield faq_model_1.Faq.create([
                {
        ...
        const testCount = yield testimonial_model_1.Testimonial.countDocuments();
        if (testCount === 0) {
            yield testimonial_model_1.Testimonial.create([
                {
                    name: "Tariqul Islam",
